...
class aPCE(object):
    ...
    def Inner_prod_MC(self, coeff1, coeff2, dat):
        """
        Approximates the integral of the product of 2 polynomials.
        """
    ...
    def Inner_prod_Quad(self, coeff1, coeff2, dat, a1, b1):
        """
        Approximates the integral of the product of 2 polynomials.
        """
    ...
    def Create_Orthonormal_Polynomials_Quad(self, p, domain):
        """
        ...
        for j in range(self.d):
            ...
            for i in range(p+1):
                ...
                P_temp_norm[i,:] = P_temp[i,:]/(np.sqrt(self.Inner_prod_Quad(P_temp[i,:],P_temp[i,:],self.X[:,j], a1, b1)))
